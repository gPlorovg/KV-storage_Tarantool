box.watch('box.status', function()
    ...
    box.space.tokens:create_index('login', { parts = { 'login' }, if_not_exists = true, unique = true })
    ...
    box.space.users:create_index('login', { parts = { 'login' }, if_not_exists = true, unique = true })
